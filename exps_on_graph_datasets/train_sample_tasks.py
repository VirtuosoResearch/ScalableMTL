...
def main(args):
    task_num = name_to_num_classes[args.dataset] if args.dataset in name_to_num_classes else args.num_communities
    ...
    for _ in range(num_samples):
        ...
        with open(sampled_task_dir, "a") as f:
            ...
            os.system("python train_node_pred_multitask.py --dataset {} --num_communities {} --task_idxes {}\
